	...
	<view>
	  <view class="two">
		  <view class="sectionBox">
			<view class="sectionType">地址：{{address}}</view>
	 ...
	 <view class="two" style="display: flex;">
	 		 <text>星级评价（1-5）:</text>
	 		 <input type="text" v-model="star" style="margin-left: 12rpx;" />
	 </view>
     ...
     <text class="btn" style="margin-right: 5px;" @click="backToHome">返回首页</text>
		 <text class="btn" @click="payClick">评价</text>
	 </view>
	</view>
</template>
